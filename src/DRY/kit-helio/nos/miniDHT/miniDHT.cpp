...
// ===== BUFFERS ESTÁTICOS =====
// messages: +3 OBRIGATÓRIO — M360Node::begin() escreve incondicionalmente em
// _messages[_count], [_count+1] e [_count+2]: intervalo (254), bateria (255) e
// debug remoto (253). Com +2 a terceira escrita sai dos limites do array.
