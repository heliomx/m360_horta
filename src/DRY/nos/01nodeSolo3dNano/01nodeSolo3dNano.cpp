...
static const M360::M360ItemDef nodeItems[] = {
    // Canteiro A - 6 sensores (Child IDs 0 a 5)
    {0, M360::M360_SENSOR, S_MOISTURE, V_LEVEL, A0, 0, 1, "A_1m_10cm", false,
     0},
    {1, M360::M360_SENSOR, S_MOISTURE, V_LEVEL, A1, 0, 1, "A_1m_30cm", false,
     0},
    {2, M360::M360_SENSOR, S_MOISTURE, V_LEVEL, A2, 0, 1, "A_2m_10cm", false,
     0},
    {3, M360::M360_SENSOR, S_MOISTURE, V_LEVEL, A3, 0, 1, "A_2m_30cm", false,
     0},
    {4, M360::M360_SENSOR, S_MOISTURE, V_LEVEL, A4, 0, 1, "A_3m_10cm", false,
     0},
    {5, M360::M360_SENSOR, S_MOISTURE, V_LEVEL, A5, 0, 1, "A_3m_30cm", false,
     0}};
...
void presentation() { node.begin("01nodeSolo3dNano", "1.0"); }
