...
static const M360::M360ItemDef nodeItems[] = {
    {1, M360::M360_SENSOR, S_MOISTURE, V_LEVEL, A0, 0, 1, "B_1m_10cm", false, 0},
    {2, M360::M360_SENSOR, S_MOISTURE, V_LEVEL, A1, 0, 1, "B_1m_30cm", false, 0},
    {3, M360::M360_SENSOR, S_MOISTURE, V_LEVEL, A2, 0, 1, "B_3m_10cm", false, 0},
    {4, M360::M360_SENSOR, S_MOISTURE, V_LEVEL, A3, 0, 1, "B_3m_30cm", false, 0},
    {5, M360::M360_SENSOR, S_MOISTURE, V_LEVEL, A4, 0, 1, "B_5m_10cm", false, 0},
    {6, M360::M360_SENSOR, S_MOISTURE, V_LEVEL, A5, 0, 1, "B_5m_30cm", false, 0}
};
 ...
 * @return Valor analógico bruto do ADC (0 a 1023)
 */
...
void presentation() { node.begin("02nodeSolo3dNano", "2.0.0"); }
