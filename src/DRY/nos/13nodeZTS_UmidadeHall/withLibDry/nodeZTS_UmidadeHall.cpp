...
// | intMin | smp | label           | wakeOnRadio | flags
static const M360::M360ItemDef NODE_ITEMS[] = {
    {CHILD_ID_MOISTURE, M360::M360_SENSOR, S_MOISTURE, V_LEVEL, -1, 1, 1,
     "Umidade ZTS", false, 0},
    {CHILD_ID_TEMP, M360::M360_SENSOR, S_TEMP, V_TEMP, -1, 1, 1, "Temp ZTS",
     false, 0},
    {CHILD_ID_CONDUCTIVITY, M360::M360_SENSOR, S_CUSTOM, V_VAR1, -1, 1, 1,
     "Condutividade Solo", false, 0},
    {CHILD_ID_PH, M360::M360_SENSOR, S_CUSTOM, V_VAR2, -1, 1, 1, "pH Solo",
     false, 0},
    {CHILD_ID_NITROGEN, M360::M360_SENSOR, S_CUSTOM, V_VAR3, -1, 1, 1, "N Solo",
     false, 0},
    {CHILD_ID_PHOSPHORUS, M360::M360_SENSOR, S_CUSTOM, V_VAR4, -1, 1, 1,
     "P Solo", false, 0},
    {CHILD_ID_POTASSIUM, M360::M360_SENSOR, S_CUSTOM, V_VAR5, -1, 1, 1,
     "K Solo", false, 0},
    {CHILD_ID_SELENOIDE, M360::M360_ACTUATOR, S_BINARY, V_STATUS, 5, 0, 0,
     "Rele ZTS", false, 0},
    {CHILD_ID_UMIDADE_HALL, M360::M360_SENSOR, S_HUM, V_HUM, A0, 1, 1,
     "Umidade Hall", false, 0},
    {CHILD_ID_LDR, M360::M360_SENSOR, S_LIGHT_LEVEL, V_LIGHT_LEVEL, A1, 1, 1,
     "Luminosidade", false, 0},
};
...
// ===== INSTÂNCIA DO MOTOR =====
// Perfil M360_PASSIVE: o nó dorme e só lê quando o gateway enviar V_CUSTOM
// FORCE_UPDATE.
static M360::M360Node node(NODE_ITEMS, NODE_ITEMS_COUNT, messages, lastValues,
                           nNoUpdates, M360::M360_PASSIVE);

// ===== IMPLEMENTAÇÃO DA LEITURA =====

float readItem(uint8_t nodeIndex) {
  // sensorDrivers.cpp::readNodeItem() gerencia a lógica de sensor ZTS vs
  // sensores locais.
