...
Este documento descreve todos os componentes necessários para a montagem física do **Nó 02 (Solo3dNano)**, versão Arduino Nano para monitoramento de solo com 6 sensores diretos (Canteiro B) no sistema M360.
