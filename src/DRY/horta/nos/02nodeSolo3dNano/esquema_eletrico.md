...
Este documento detalha as conexões físicas e lógicas do **Nó 02 (Solo3dNano)** (Monitoramento 3D de Solo, versão Arduino Nano), responsável por ler 6 sensores de umidade diretamente no Canteiro B.
...
| :---: | :--- | :--- |
| **Sensor 0 (B_1m_10cm)** | A0 | D3 (VCC Chaveado via resistor 10k) |
| **Sensor 1 (B_1m_30cm)** | A1 | D3 (VCC Chaveado via resistor 10k) |
| **Sensor 2 (B_3m_10cm)** | A2 | D3 (VCC Chaveado via resistor 10k) |
| **Sensor 3 (B_3m_30cm)** | A3 | D3 (VCC Chaveado via resistor 10k) |
| **Sensor 4 (B_5m_10cm)** | A4 | D3 (VCC Chaveado via resistor 10k) |
| **Sensor 5 (B_5m_30cm)** | A5 | D3 (VCC Chaveado via resistor 10k) |
