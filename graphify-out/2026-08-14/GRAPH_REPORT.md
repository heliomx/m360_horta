# Graph Report - m360_horta  (2026-08-13)

## Corpus Check
- 1198 files · ~1,695,495 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 13363 nodes · 14360 edges · 1174 communities (1085 shown, 89 thin omitted)
...
- `loop()` --calls--> `updateLEDs()`  [INFERRED]
  src/DRY/horta/gateway/Deprecated_newGatewayMqtt.cpp → lib/M360-DRY/src/M360Leds.cpp
- `setup()` --calls--> `updateLEDs()`  [INFERRED]
...
## Communities (1174 total, 89 thin omitted)
...
Cohesion: 0.16
Nodes (17): ledFlicker(), checkNodeTimeouts(), byte, JsonDocument, MyMessage, String, gatewayTransportSend(), getNodeCategoryLabel() (+9 more)
...
Cohesion: 0.15
Nodes (17): checkNodeTimeouts(), JsonDocument, MyMessage, gatewayTransportSend(), loop(), NodeStatus, active, lastSeen (+9 more)
...
Cohesion: 0.22
Nodes (11): LedState, initLEDs(), ledBegin(), setLedState(), updateLEDs(), before(), before(), isA0Low() (+3 more)
...
Cohesion: 0.04
Nodes (45): 1.1 Identificação, 1.2 Placa, 1.3 Perfil de Energia, 1.4 Rádio nRF24L01+, 1.5 Gestão de VCC dos sensores, 1.6 Log de RSSI periódico, 1.7 Sensores e Atuadores, 2.1 Validação de conflitos (+37 more)
...
Cohesion: 0.10
Nodes (20): 1. Arquitetura e Motor DRY, 2.1 Buffers dos nós M360-DRY, 2.2 Ciclo de Vida (Setup), 2.3 Loop de Reporte (Regra de Mudança Significativa), 2.4 Padronização de IDs, Tópicos MQTT e Auto-Discovery (Proxy MCP v2.0), 2. Padrões de Implementação (Nós), 3. Comandos e Eventos Customizados (V_CUSTOM / V_VAR1), 4. Gateway — Padrões do `newGatewayMqtt.cpp` (+12 more)
...
## Knowledge Gaps
- **7368 isolated node(s):** `$schema`, `title`, `description`, `type`, `workflow_version` (+7363 more)
...
- **What connects `$schema`, `title`, `description` to the rest of the system?**
  _7368 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `kit-helio/gateway/libDryGatewayMqtt.cpp` be split into smaller, more focused modules?**
